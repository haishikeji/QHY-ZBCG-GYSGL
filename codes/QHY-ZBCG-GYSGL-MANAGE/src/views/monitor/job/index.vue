<template>
  <div class="app-container search-table-box aidex-table">
            ...
            <el-row :gutter="16">
              ...
              <el-col :md="6">
                <el-form-item label="任务组名" prop="jobGroup">
                  <el-select v-model="queryParams.jobGroup" placeholder="请选择任务组名" clearable @change="handleQuery" style="width: 100%">
                     <el-option
              ...
              <el-col :md="6">
                <el-form-item label="任务状态" prop="status">
                  <el-select v-model="queryParams.status" placeholder="请选择任务状态" clearable @change="handleQuery" style="width: 100%">
                     <el-option
    ...
    <el-card shadow="never" >
      ...
      <el-table stripe ref="tableRef" v-loading="loading" :data="jobList" @selection-change="handleSelectionChange" highlight-current-row style="width: 100%;" :height="tableHeight">
      ...
      <el-dialog :title="title" v-model="open" width="720px" append-to-body>
        <div class="dialog_box">
          <el-form ref="jobRef" :model="form" :rules="rules" label-position="top">
            <el-row :gutter="24">
              <el-col :span="12">
                <el-form-item label="任务名称" prop="jobName">
     ...
     <el-dialog title="Cron表达式生成器" v-model="openCron" append-to-body destroy-on-close>
      ...
      <!-- 任务日志详细 -->
      <el-dialog title="任务详细" v-model="openView" width="720px" append-to-body>
        <div class="dialog_box">
            ...
            <el-row :gutter="24">
              ...
              <el-col :span="12">
                <el-form-item label="任务分组：">
                  <el-select v-model="form.jobGroup" disabled  >
                     <el-option
                        v-for="dict in sys_job_group"
                        :key="dict.value"
                        :label="dict.label"
              ...
              <el-col :span="12">
                <el-form-item label="cron表达式">
                  <el-input v-model="form.cronExpression" disabled/>
                </el-form-item>
              </el-col>
              <el-col :span="12">
              ...
              <el-col :span="12">
                <el-form-item label="是否并发">
                  <el-input v-if="form.concurrent == 0" placeholder="允许" disabled></el-input>
                  <el-input v-if="form.concurrent == 1" placeholder="禁止" disabled></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="执行策略">
                  <el-input v-if="form.misfirePolicy == 0" placeholder="默认策略" disabled></el-input>
                  <el-input v-if="form.misfirePolicy == 1" placeholder="立即执行" disabled></el-input>
                  <el-input v-if="form.misfirePolicy == 2" placeholder="执行一次" disabled></el-input>
                  <el-input v-if="form.misfirePolicy == 3" placeholder="放弃执行" disabled></el-input>
                </el-form-item>
              </el-col>
            </el-row>
          </el-form>
